...
<?php
			...
			if($prev){
				...
				$prevMarkup = '<a class="prev" href="'. $url .'" title="Previous Artwork in '. $categories[$nav_cat_id]->name .': ' . $imgdata['caption']  . '" ><span>'. $imgdata['tag'] .'</span></a>';
			}else{
				$prevMarkup = '' ;
			}
			...
			if($next){
				...
				$url = add_querystring_var($url, 'mb_cat',$categories[$nav_cat_id]->term_id);
				$nextMarkup = '<a class="next" href="'. $url .'" title="Next Artwork in '. $categories[$nav_cat_id]->name .': ' . $imgdata['caption']  . '" ><span>'. $imgdata['tag'] .'</span></a>';
			}else{
				$nextMarkup = '' ;
			}
